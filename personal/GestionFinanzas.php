...
<script>
	...
	let a = document.getElementById('producto').value;
	let b = document.getElementById('plataforma').value;
	let c = document.getElementById('clase').value;
	let d = document.getElementById('monto').value;
	let e = document.getElementById('costo').value;
	let f = document.getElementById('comentarios').value;
	let g = document.getElementById('formaCobro').value;
	let h = document.getElementById('cobro').value;
	let i = document.getElementById('fecha').value;
	let j = document.getElementById('nota').value;
	let k = document.getElementById('us').value;
	let l = document.getElementById('referencia').value;
	//let m = 
	document.getElementById('registrarIng').addEventListener('onclick',function(){
