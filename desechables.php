...
<section class="parallax hero_p">
	...
	<div class="presentacion">
		...
		<p>Mas de 30 años de experiencia a tu servicio te garantizan calidad y precio. Contacta sin compromiso para cotizar venta por cajas y bultos, (pregunta, probablemente tenemos). Visita nuestra tienda en linea.</p>
...
<div class="aletarga">
	...
	<div class="catalogo">
		<a target="_blank" href="<?php echo $t_mercadoShops;?>">
			<img class="img_cont" src="imagenes/i.png" alt="loading..."/></a>
		<a target="_blank" href="<?php echo $t_mercadoShops;?>">
			<img class="img_cont" src="imagenes/b.png" alt="loading..."/></a>
		<a target="_blank" href="<?php echo $t_mercadoShops;?>">
			<img class="img_cont" src="imagenes/c.png" alt="loading..."/></a>
		<a target="_blank" href="<?php echo $t_mercadoShops;?>">
			<img class="img_cont" src="imagenes/d.png" alt="loading..."/></a>
		<a target="_blank" href="<?php echo $t_mercadoShops;?>">
			<img class="img_cont" src="imagenes/e.png" alt="loading..."/></a>
		<a target="_blank" href="<?php echo $t_mercadoShops;?>">
			<img class="img_cont" src="imagenes/f.jpg" alt="loading..."/></a>
		<a target="_blank" href="<?php echo $t_mercadoShops;?>">
			<img class="img_cont" src="imagenes/j.jpg" alt="loading..."/></a>
		<a target="_blank" href="<?php echo $t_mercadoShops;?>">
			<img class="img_cont" src="imagenes/h.jpg" alt="loading..."/></a>
		<a target="_blank" href="<?php echo $t_mercadoShops;?>">
			<img class="img_cont" src="imagenes/a.jpg" alt="loading..."/></a>
		<a target="_blank" href="<?php echo $t_mercadoShops;?>">
			<img class="img_cont" src="imagenes/k.png" alt="loading..."/></a>
		<a target="_blank" href="<?php echo $t_mercadoShops;?>">
			<img class="img_cont" src="imagenes/g.png" alt="loading..."/></a>
		<a target="_blank" href="<?php echo $t_mercadoShops;?>">
			<img class="img_cont" src="imagenes/l.png" alt="loading..."/></a>
    </div>
</div>
<footer>
    <ul class="social_icon">
    	<li><a href="<?php echo $facebook;?>"><ion-icon name="logo-facebook"></ion-icon></a></li>
    	<li><a href="<?php echo $google;?>"><ion-icon name="logo-google"></ion-icon></a></li>
...
<div class="grid-container">
    <div>
        <a href="<?php echo $t_mercadoShops;?>"><img class="logo" src="imagenes/COORP (2).jpg" /></a>
    </div>
    <div>
    ...
    <div>
        <a target="_blank" href="http://admingtutoriales.com/"><img class="logo" src="imagenes/adming.jpg" /></a>
    </div>
</div>
</div>
<div id="nosotros" class="modal"><!--Nosotros-->
	...
	<a target="_blank" href="<?php echo $t_mercadoShops;?>"><button class="btnML btn-darkML">
		<div class="icono">
			<svg width="16" height="16" fill="currentcolor"><img src="imagenes/ml.png" width="25" height="25" /></svg>
		</div>
