...
<head>
    ...
    <meta http-equiv="content-security-policy|Content-Type|default-style|refresh" content="text/html; width=device-width; charset=utf-8;" initial-scale="1.0"/>
        <title>Compra Exitosa | Gracias</title>
	<?php include 'negocio\compraExitosa.php';?>
...
<header id="main-header">
    ...
    <nav>
        <ul>
            <li><a class="activo" target="_blank" href="https://materiasprimastocha.mercadoshops.com.mx/" style="color:#415;">Mercado Libre</a></li>
            <li><a target="_blank" href="<?php echo $google;?>" style="color:#415;">Google</a></li>
            <li><a id="buttonUs" style="color:#415;">Acerca de</a></li>
            <li><a target="_blank" href="contacto_tocha.html" style="color:#415;">Contacto</a></li>
