...
<div class="aletarga" style="display:fixed;">
	...
	<div class="contNoti">
		...
		<div class="contentNoti">
			...
			<p>Comercio de fertilizantes y otros articulos para huerto urbano
			</p>
		</div>
	</div>
		<span>BioMas</span>
	...
	<div class="contNoti">
		<div class="contentNoti">
			...
			<p>Una seleccion de los mejores articulos de electronica en Amazon con la mejor relacion precio calidad
			</p>
		</div>
	</div>
